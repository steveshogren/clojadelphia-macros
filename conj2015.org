...
Abstract: 
How do you build an Enterprise team that can rapidly build high-quality features for a decade? You hire great people, and entrust them. In this talk I will share lessons learned from a decade of self-organizing teams. Join me in observing statistics about our 4.3 million line codebase built entirely with TDD and pair-programming. We will be talking about how you can build such a team from the ground up, and the potential challenges you will face. 
